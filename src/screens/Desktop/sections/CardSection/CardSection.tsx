...
// Target date for countdown (2 days from now)
const targetDate = new Date();
targetDate.setDate(targetDate.getDate() + 2);
targetDate.setHours(6, 15, 48, 0);
...
This is how freedom becomes reality - one card, one tap
            ...
            <div className="flex flex-row items-center gap-3.5 w-full translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms]">
{featureCards.map((feature, index) => (
                <Card key={index} className="flex-1 min-w-0 rounded-[19.69px] border-none shadow-[0px_3.75px_16.22px_#7188a733] backdrop-blur-[5.2px] bg-[linear-gradient(327deg,rgba(255,255,255,0.2)_0%,rgba(235,243,255,0.2)_100%)] before:content-[''] before:absolute before:inset-0 before:p-0.5 before:rounded-[19.69px] before:[background:linear-gradient(168deg,rgba(255,255,255,1)_0%,rgba(255,255,255,0.5)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none transition-all duration-300 hover:shadow-[0px_6px_20px_#7188a744] hover:scale-105 hover:bg-[linear-gradient(327deg,rgba(255,255,255,0.4)_0%,rgba(235,243,255,0.4)_100%)]">
                <CardContent className="flex items-center justify-center gap-3 px-4 py-2">
                  <img
                    className="w-8 h-8 object-contain"
                    alt="Feature icon"
                    src={feature.icon}
                  />
                  <div className="text-lg font-bold text-[#62638a] tracking-[-0.5px] [font-family:'Wix_Madefor_Text',Helvetica] leading-normal whitespace-pre-line">
                    {feature.title}
                  </div>
                </CardContent>
</Card>
...
Limited time offer - 15% discount on all our plans
        ...
        <CountdownTimer targetDate={targetDate} className="w-full max-w-[689px]" />
<p className="text-xl font-bold text-[#404169] [font-family:'Wix_Madefor_Text',Helvetica] text-center leading-normal">
This is how freedom becomes reality - one card, one tap
        </p>
        <Button className="w-[190px] h-auto gap-[12.5px] p-[12.5px] rounded-[37.5px] shadow-[0px_3.75px_7.88px_#95aed2] bg-[linear-gradient(160deg,rgba(33,36,124,1)_0%,rgba(55,59,188,1)_100%)] text-white text-[25px] font-semibold [font-family:'Wix_Madefor_Text',Helvetica] transition-all duration-300 hover:shadow-[0px_6px_12px_#95aed2] hover:scale-105 hover:bg-[linear-gradient(160deg,rgba(25,28,100,1)_0%,rgba(45,49,170,1)_100%)] active:scale-95">
          Buy now
        </Button>
</div>
...
price
                  ...
                  <Button className="absolute top-[357px] left-[59px] w-[152px] h-auto gap-2.5 p-2.5 rounded-[30px] shadow-[0px_3px_6.3px_#95aed2] bg-[linear-gradient(160deg,rgba(33,36,124,1)_0%,rgba(55,59,188,1)_100%)] text-white text-xl font-semibold [font-family:'Wix_Madefor_Text',Helvetica] transition-all duration-300 hover:shadow-[0px_5px_10px_#95aed2] hover:scale-105 hover:bg-[linear-gradient(160deg,rgba(25,28,100,1)_0%,rgba(45,49,170,1)_100%)] active:scale-95">
                    Buy now
                  </Button>
</CardContent>
</Card>
              <div className="absolute top-[18px] left-2.5 w-[273px] h-[168px] rotate-[-8deg] transition-all duration-300 group-hover:rotate-[-6deg] group-hover:scale-105">
<img
