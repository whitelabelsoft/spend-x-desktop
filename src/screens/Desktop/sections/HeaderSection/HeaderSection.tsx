...
export const HeaderSection = (): JSX.Element => {
  ...
  return (
    <header className="flex w-full max-w-[1150px] mx-auto items-center justify-between px-4 sm:px-5 py-3 sm:py-3.5 relative bg-transparent rounded-[32px] sm:rounded-[72px] border-[none] shadow-[0px_4px_17.3px_#7188a733] backdrop-blur-[5.55px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(5.55px)_brightness(100%)] bg-[linear-gradient(327deg,rgba(255,255,255,0.8)_0%,rgba(235,243,255,0.8)_100%)] before:content-[''] before:absolute before:inset-0 before:p-[1.5px] before:rounded-[32px] sm:before:rounded-[72px] before:[background:linear-gradient(168deg,rgba(255,255,255,1)_0%,rgba(255,255,255,0.5)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none translate-y-[-1rem] animate-fade-in opacity-0">
      ...
      <div className="inline-flex items-center gap-3 sm:gap-5 relative flex-[0_0_auto] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms]">
        <img
          className="relative w-5 h-5 sm:w-6 sm:h-6 transition-all duration-300 hover:scale-110 cursor-pointer"
          alt="Night mode"
        ...
        <Button className="w-[120px] sm:w-[152px] gap-2 sm:gap-2.5 p-2 sm:p-2.5 rounded-[24px] sm:rounded-[30px] shadow-[0px_3px_6.3px_#95aed2] flex items-center justify-center relative bg-[linear-gradient(160deg,rgba(33,36,124,1)_0%,rgba(55,59,188,1)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)] hover:shadow-[0px_4px_8px_#95aed2] transition-all duration-300 hover:scale-105 h-auto">
          <div className="relative w-fit mt-[-1.00px] [font-family:'Wix_Madefor_Text',Helvetica] font-semibold text-white text-sm sm:text-xl text-right tracking-[0] leading-[normal]">
            Buy now
          </div>
        </Button>
      </div>
